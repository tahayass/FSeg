...
def GenerateMasksForDataset(coco_dataset_path,dataset_name=''):
    ...
    for id in tqdm(image_ids):
        ...
        masks = GenerateMaskForImage(image, bounding_boxes=image_annotation[id])
...
def GenerateMaskForImage(image, bounding_boxes=[]):
...
if __name__=='__main__':
    ...
    coco_dataset_path = r'.\Data\Fseg-food-detection-1\test'
    
    GenerateMasksForDataset(coco_dataset_path,dataset_name='test')
